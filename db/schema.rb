...
ActiveRecord::Schema[7.1].define(version: 20_240_623_025_355) do
  ...
  create_table 'props', force: :cascade do |t|
    ...
    t.index %w[slotted_id slotted_type], name: 'index_props_on_slotted_id_and_slotted_type'
    t.index %w[slotted_type slotted_id], name: 'index_props_on_slotted'
  end
